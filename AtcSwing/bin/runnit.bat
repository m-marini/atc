...
rem $Id: runnit.bat,v 1.2 2008/02/27 15:00:25 marco Exp $
...
echo.
echo Batch tries to run javaw. It should be in PATH system environment variable.
echo.
