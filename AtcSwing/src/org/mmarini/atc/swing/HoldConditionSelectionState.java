 ...
 * 
 */
public class HoldConditionSelectionState extends CommanderStateAdapter
		implements UIAtcConstants {

	/**
	 * 
	 */
	public HoldConditionSelectionState() {
	}
	...
	public void entitiesSelected(EntitySet set) {
		...
		getController().selectHoldCondition(location.getId());
	}
	...
	public void notifyLocationSelection(String locationId) {
		getController().selectHoldCondition(locationId);
	}
}
