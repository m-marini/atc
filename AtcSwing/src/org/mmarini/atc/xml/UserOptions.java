...
public class UserOptions implements XmlConstants {
	...
	elem.setAttributeNS(ATC_OPTIONS_NS, HITS_PLANE_COUNT_ATTR, String
		.valueOf(record.getPlaneCount()));
	elem.setAttributeNS(ATC_OPTIONS_NS, HITS_ITERATION_COUNT_ATTR, String
		.valueOf(record.getIterationCount()));
	elem.setAttributeNS(ATC_OPTIONS_NS, HITS_PROFILE_ATTR, record
		.getProfile());
	elem.setAttributeNS(ATC_OPTIONS_NS, HITS_TIME_ATTR, String
		.valueOf(record.getTime()));
	elem.setAttributeNS(ATC_OPTIONS_NS, HITS_MAP_NAME_ATTR, record.getMapName());
	return elem;
    }
}
